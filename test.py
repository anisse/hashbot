...
def test_filter():
    filter_tests_strings = [
            ...
            ("""da6a36097a2b3383db1aaf98cea0ad1cd8973bce""", True),
            # Extracted from https://twitter.com/#!/KZENIKzx/status/189769476756090880
            ("""@dRacokim เค้าพูดความจริงไง อาจพึ่งรู้ตัวไรเง้5555555555555555555555555555555555555555""", False),
            # Extracted from https://twitter.com/#!/mjg59/status/184651598373457920
            ("""ad23d1317c1230c72a1a8b88b442f516""", True),
            # Extracted from https://twitter.com/#!/Aissn/status/189475112267956225
            ("""Future proofing ba351eaa0880baaa8482edc021c872c2""", True),
            # Extracted from https://twitter.com/#!/super_ttoon/status/189766242930925568
            ("""เอลฟ์อย่าทำร้ายมิน เราต้องบอกว่ามินผอม มินผอม เอารูปนี้ไปดูแล้วท่อง http://t.co/ByHSqGjV 55555555555555555555555555555555""", False),
            # Extracted from https://twitter.com/#!/Larissa_Ferrari/status/189763441156829184
            ("""@ericacasmartins @LineTheodoro EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE \õ/ HAUAHAUAHUAUAHAUAHAUHAUAHAUAHAUA""", False),
            # Extracted from https://twitter.com/#!/js_yuri125/status/189720096615305218
            ("""120410 사랑비 Love Rain E06 윤아 Cut TP (by Moonlight) magnet:?xt=urn:btih:89333B05CE1E7C2736B321CDACE48926CD69069D #loverain #yoona #윤아""", False),
            # Extracted from https://twitter.com/#!/_SilviaFromMars/status/189740926145544193
            ("""Mi piacciono i numeri [cit] 3287619519265713204635687603651657675617 #ITALIANDIRECTIONERSLOVEONED""", False),
            # Extracted from https://twitter.com/#!/kookai4825/status/189733313475383297
            ("""I downloaded video af5806f9ba73d87fc6dc1244ca11d447.flv - http://t.co/ySGC5BZl""", False),
            # Extracted from https://twitter.com/#!/HounamHazza/status/189729748308590592
            ("""#1DMerda ☺☻♥♠○◘•☼◙ 46373684268237986278428024892479 +7yu7ey3r4es= #1DMerda #1DMerda #1DMerda #1DMerda dysjhkdfhjsdhjkhjdvgh7643389893zz""", False),
            # Extracted from https://twitter.com/#!/_rlaxodus/status/189719615469924353
            ("""120410 Love Rain full by moonlight magnet:?xt=urn:btih:FC56D0914827363AEB15115161EBE915A8BDE19F""", False),
            # Extracted from https://twitter.com/#!/_yearn/status/189725676830597121
            ("""패션왕 E08.720p mp4 (748MB) magnet:?xt=urn:btih:DB31676546FE4F421F4196F336EFDBDB3209A0AF""", False),
            # Extracted from https://twitter.com/#!/yuldori/status/189718589958406145
            ("""120410 Fashion King - Ep. 08 (Moonlight) magnet:?xt=urn:btih:83C04E6894809029BEC2D37CB5F30A32114DF1ED""", False),
            # Extracted from https://twitter.com/#!/BlackDahliaDie/status/189700505268793344
            ("""1000000100000001001100010000000110000001011100010011000100110000 esta, por ejemplo. Os acabo de llamar gilipollas y ni os habéis enterado.""", False),
            # Extracted from https://twitter.com/#!/stephanietamp/status/189716523655512064
            ("""RT @mentarimamonto RT @sarahndrk adaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa aja cobaan nya kl lg bnr2 syg sm orang. haduuuh""", False),
            # Extracted from https://twitter.com/#!/Lastbyezzz/status/189715877745262592
            ("""63ce1f16518ff4702f942cc212d2628a""", True),
            # Extracted from https://twitter.com/#!/ljmiolleh/status/189712249651331073
            ("""@zniiperr ขำเลยกูเจอคำว่าฟิน 55555555555555555555555555555555""", False),
            # Extracted from https://twitter.com/#!/1DandJBFansTR/status/189711515648147456
            ("""@Jawaad_S I love you &lt;33333333333333333333333333333333""", False),
            # Extracted from https://twitter.com/#!/balliiteeee/status/189692649698111489
            ("""@lauravizla :DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD DAUNE! :DDDDDDDDDDDDD Es te bļeģ smejos par tevi. :DDD Es Endiju pasaukšu. :DDD""", False),
            # Extracted from https://twitter.com/#!/Mr3bhom/status/189687893340598273
            ("""يــــوم الجمعـــــة 25 /4/ 1433 . http://184.105.234.34/50/58/5058810dbe16d51106541a530410c875/ba64807/5058_w_1.3gp?PIN:26D3655E""", False),
            # Extracted from https://twitter.com/#!/planpan/status/189671049338691585
            ("""เยดดดดดดดดด มาดามอังแคแนดังล๊าวววววววววววว ดอกกกก เกิดเชี่ยอะไรกับประเทศนี้กันนนนน 555555555555555555555555555555555555555555555555555555555""", False),
            # Extracted from https://twitter.com/#!/_0386580450682/status/189670407304003585
            ("""محشش طرباان يصلي ورالامام  http://64.71.156.132/d4/3e/d43e48ca0736f96c2fbc98fb57fea4cd/ba124807/d43e_w_1.3gp?c=141232906&u=615244077&s=BLs5m""", False),
            # Extracted from https://twitter.com/#!/StickleA/status/189659556614373376
            ("""(2012Q2) 這いよれ！ニャル子さん 第01話 「第三種接近遭遇、的な」 (TX 1280x720 x264 AAC).mp4 JpazsuDaqe 320,716,998 e94265e3e0cb639d72c53a64c2b63341a953370a""", True),
            # Extracted from https://twitter.com/#!/malwr/status/189649305731203072
            ("""[66ebf239705ed81bae9a0c9763a6b42b] Analysis at http://t.co/Mn2BXBfO""", False),
            # Extracted from https://twitter.com/#!/bofarj/status/189648588534587392
            ("""أغنى خمسه أشخاص في العالم 🏧
...
http://184.105.234.201/41/6e/416ef1cd2ebb81097c502223eb3c600c/ba123207/416e_w_2.3gp?c=123959570&u=793686681&s=BMTtpH""", False),
            ...
            ("""เอสเจจะรู้มั้ยว่านางฟ้าของพวกมึงตอนนี้เป็นควายกันไปหมดเเล้ว 55555555555555555555555555555555""", False),
            # Extracted from https://twitter.com/#!/Moni_Lovo/status/189579491541135360
            ("""Ignorada como por 96541254523654525541587863999954 vez :)""", False),
            # Extracted from https://twitter.com/#!/Faii__JB/status/189567944659959808
            ("""ด่าตีนกาอิทึกดิไม่มีใครว่าหรอก 55555555555555555555555555555555""", False),
            # Extracted from https://twitter.com/#!/_mperla/status/189564203332415488
            ("""diz : foi bom ter te visto , vou sentir saudades :/ AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA qero morrer ))))))):""", False),
            # Extracted from https://twitter.com/#!/AleBrausin/status/189535447188385792
            ("""@LauraAyalaS AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA♥""", False),
            # Extracted from https://twitter.com/#!/fcLRDSpe/status/189500470891515905
            ("""[AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA] Q ORGULHO, Q ORGULHO MEU DEUS [AAAAAAAAAAAA]""", False),
            # Extracted from https://twitter.com/#!/Maaria_Laaura/status/189495739712417792
            ("""FATO: podem ter 5678765434567898765434567876543456787654 pessoas online no meu tumblr, mais nenhuma delas... http://t.co/w9fjrWn9""", False),
            # Extracted from https://twitter.com/#!/YoDrupi/status/189493424456613890
            ("""AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA Esto no puede estar pasando, no otra vez u_u""", False),
            # Extracted from https://twitter.com/#!/raichanxd/status/189389693589258241
            ("""[HD] 120409 MBC K-Pop special - SM Town Live in Tokyo (SJ cut) magnet:?xt=urn:btih:AABF5E400DCD21A3898889DC12A67CFB71E5A0A7""", False),
            # Extracted from https://twitter.com/#!/liviasi__/status/189488613568950273
            ("""@laurabacaxi AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA PALPITACAO NO CORACAAAAAAAAAO""", False),
